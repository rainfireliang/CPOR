...
Estimate effects between two consecutive periods. Set t=1 to estimate effects between period 1 and period 2.
...
MutiplexEffects <- getEffects(MutiplexData) # by default the model includes rate, degree, reciprocity effects
...
# include dyadic interaction effect within versus between effect
